from src.components.ideal_brayton_cycle import ideal_brayton_cycle
from src.components.irreversibilities_brayton_cycle import irreversibilities_brayton_cycle
from src.libraries.performance_metrics import performance_metrics
from src.libraries.general_functions import volumetric_to_mass_flow_rate
from src.libraries.get_fluid_properties import get_fluid_properties

def main(P1, P4, T1, T3, rc, volumetric_flow_rate, isentropic_compressor_eff, isentropic_turbine_eff):
    ...
    "Wc": Wc,
    "Wt": Wt,
    "Wnet_work_based": Wnet_work_based,
    "Wnet_heat_based": Wnet_heat_based,
    "bwr": bwr,
